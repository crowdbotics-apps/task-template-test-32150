...
## Project Structure
    ...
    ├── task_template_test_32150  # Django project configurations
...
1. Clone this repo and `cd task_template_test_32150`
...
2. Clone this repo and `cd task_template_test_32150`
